...
## 鑒權/認證
:::info
請先生成<a href="https://testnet.bybit.eu/app/user/api-management"><b>測試網</b></a>或<a href="https://www.bybit.eu/app/user/api-management"><b>主網</b></a>API KEY。
:::
